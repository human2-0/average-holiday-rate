              ...
              child: SingleChildScrollView(
                ...
                child: Consumer(
                  builder: (context, ref, child) {
                    final payslipAsyncValue = ref.watch(payslipStreamProvider);

                    return payslipAsyncValue.when(
                      data: (payslips) {
                        // Create a sorted list of unique month/year strings
                        final monthsList = payslips
                            .map(
                                (payslip) => formatMonthYear(payslip.startDate),)
                            .toSet()
                            .toList();
                              ...
                              child: Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return ListTile(
                                      title: Text(
                                        'Hours: ${payslip.hoursWorked}, Bonuses: ${payslip.bonusesEarned}',
                                      ),
                                    );
                                  },
                                ),
